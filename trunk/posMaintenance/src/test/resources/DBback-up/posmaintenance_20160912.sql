...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('schedulerFactory', 'user-PC1473694414435', '1473694986192', '7500');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=469504245213691905 DEFAULT CHARSET=utf8 COMMENT='操作日志表';
